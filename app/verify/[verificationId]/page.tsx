...
function VerificationShell({ children }: { children: React.ReactNode }) { return <main className="grid min-h-screen place-items-center bg-[#f4f7f5] p-4 text-[#18251f]"><div className="w-full max-w-3xl"><header className="mb-5 flex items-center gap-3"><span className="grid size-11 place-items-center rounded-xl bg-[#183f30] text-white"><Award size={20}/></span><div><b className="font-display block">Credential verification</b><span className="text-xs text-[#718078]">Asia Professional Speakers Singapore</span></div><Link href="/" className="ml-auto text-xs font-bold text-[#397258]">Commune</Link></header>{children}</div></main>; }
